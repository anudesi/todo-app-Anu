...
export const verifyToken = (req, res, next) =>{
    try{
        ...
        // So first we are converting this text into an Array according to the space between Bearer word and our Token
        ...
        // At this point using two methods of jwt 
        // - decode method = that will be used to decode a O-Auth Token( here Google token) and it normally consists on more than 500 characters
        // - sign method = to verify the token and to get payload. But this method will be used to verify token that is generated by use
